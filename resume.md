...
[cite_start]**Email:** peterloleit@gmail.com [cite: 2]
[cite_start]**Mobile:** +44 7974329778 or +49 15252348277 [cite: 2]
[cite_start]**LinkedIn:** https://www.linkedin.com/in/peterloleit/ [cite: 2]
[cite_start]**Address:** 28309 Bremen, Germany [cite: 3]
[cite_start]**Nationality:** UK and German (EU) [cite: 3]

---

## [cite_start]EXECUTIVE SUMMARY [cite: 4]

[cite_start]I help businesses **scale internationally** by optimizing marketing operations, accelerating e-commerce revenue growth, building high-impact data teams, and executing **strategic digital transformations** delivering multi-million-dollar returns[cite: 5]. [cite_start]I partner with leaders to design and execute strategic transformations, architecting a culture of **data-driven decision-making** that yields lasting, measurable returns[cite: 6].

[cite_start]Highly accomplished and results-driven Analytics Executive with over **25 years of experience**, leveraging expertise in **Data, Analytics, AI, and E-commerce Technology** to drive strategic digital transformations[cite: 7]. [cite_start]Proven success in designing and executing enterprise-wide data strategies and embedding data-driven decision-making across diverse sectors, including Financial Services, Media & Entertainment, Retail, and Technology in **EMEA and US, and APAC**[cite: 8]. [cite_start]Expert in program management and leading high-impact, cross-functional, global teams (onshore, offshore, and hybrid)[cite: 9].

---

## [cite_start]EXPERIENCE [cite: 10]

### [cite_start]Senior Consultant and Lead Strategist at eClerx Ltd (July 2022 - Sept 2024) [cite: 11]
[cite_start]**Focus:** Strategic Account Growth, Data Leadership, and OTT Analytics [cite: 11]

* [cite_start]Directed and scaled high-performing award-winning onshore/offshore data teams for **Comcast Sky** from 8 to 20+ FTEs across BI, MarTech, and Data Engineering, delivering enterprise data solutions for five **OTT streaming brands** in 70 countries[cite: 13].
* [cite_start]Supported Analytics rollout for **SkyShowTime** and **Showmax** Launches, ensuring 100% day one reporting accuracy and post-launch analysis[cite: 14].
* [cite_start]Drove significant organizational growth by doubling **eClerx Resourcing revenue to \$2M** annually and onboarding two new business units: Sky Business and Martech[cite: 14].
* [cite_start]Directed a Gold Layer OTT Data Integration initiative for Sky Data to consolidate petabytes of data and thousands of queries/views, driving a **45% reduction in query latency** and **30% reduction in speed-to-insight**[cite: 15].
* [cite_start]Architected a critical data quality initiative for Sky OTT Ecommerce to resolve an Adobe Analytics attribution issue, achieving **100% improvement in cross-channel reporting accuracy** and enabling data-driven trading[cite: 16].
* [cite_start]Designed and delivered a CEO/CTO-backed L1 Target Operating Model (TOM) across Data, PMO, Acquisition & Retention for **GEDI Gruppo Editoriale**, driving major process transformation[cite: 17, 18].
* [cite_start]Enabled GEDI Digital's growth to **31M monthly users** through predictive analytics and churn-reduction programs[cite: 18].
* [cite_start]Provided Strategic Advisory and Thought Leadership for major clients (Sky Comcast, M&S, ABB) on Future Trends, CX Strategy, Product & Data Management, and **Generative AI for Analytics and Product Enrichment**[cite: 19].

### [cite_start]Digital Marketing and Ecommerce Consultant at TSK AB (Jan 2020 - July 2022) [cite: 20]
[cite_start]**Focus:** Privacy Compliance, BI Architecture, and E-commerce Acceleration [cite: 20]

* [cite_start]Architected the migration of Svea Bank's tagging and reporting to a fully **GDPR and PII-compliant Matomo platform**, eliminating 100% privacy risk and creating a unified B2B and B2C data view[cite: 21].
* [cite_start]Consolidated 50+ healthcare analytics sites for public sector entity Region of Skäne, including 10 hospitals, into a unified reporting platform, cutting reporting time by **50%** for key decision-makers[cite: 22].
* [cite_start]Optimized Shopify e-commerce sites, implementing GA/GA4 and SEO to drive a **10x revenue increase** within 2 years for Corrosion Group AB[cite: 23].

### [cite_start]Co-founder Digital Analytics Consultants (July 2021 - Present) Independent [cite: 24]
[cite_start]**Focus:** Privacy Compliance, Data Collection & BI Architecture, E-commerce Acceleration [cite: 25]

* [cite_start]Delivering expert consulting services in Digital Analytics, Ecommerce and SEO, Analytics & BI, Data collection, **Privacy regulation compliance (GDPR)**, **AI (EU AI Act, GPAI)** and **Data Governance**[cite: 26].
* [cite_start]International focus on Nordics partnering with TSK AB in Sweden on Retail, Healthcare and Public sector clients[cite: 26].

### [cite_start]Head of Ecommerce, Technology and SEO at SLX Marketing (Aug 2018 - Jan 2020) [cite: 28]
